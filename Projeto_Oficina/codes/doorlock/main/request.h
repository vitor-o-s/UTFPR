...
#define HOST_AWS_FUNCTION "eq62sd0kbj.execute-api.us-east-1.amazonaws.com"
#define PATH_AWS_FUNCTION "/prd/new-access"
...
/* Root cert for howsmyssl.com, taken from howsmyssl_com_root_cert.pem
   ...
   openssl s_client -showcerts -connect https://api.github.com/users/gprando55:443 </dev/null
...
void post_request(uint8_t *buf)
{
  ...
  esp_http_client_config_t config = {
      .host = HOST_AWS_FUNCTION,
      .path = PATH_AWS_FUNCTION,
      .transport_type = HTTP_TRANSPORT_OVER_TCP,
      .event_handler = _http_event_handler,
  };
  esp_http_client_handle_t client = esp_http_client_init(&config);

  const char *post_data = (char *)buf;
