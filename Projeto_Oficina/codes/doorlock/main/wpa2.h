...
#define EXAMPLE_EAP_ID "a20"
#define EXAMPLE_EAP_USERNAME "a20"
...
static const char *TAG_WPA = "example";
...
static void initialise_wifi(void)
{
    ...
    ESP_LOGI(TAG_WPA, "Setting WiFi configuration SSID %s...", wifi_config.sta.ssid);
...
#endif /* CONFIG_EXAMPLE_EAP_METHOD_TTLS */
#if defined (CONFIG_EXAMPLE_WPA3_192BIT_ENTERPRISE)
    ESP_LOGI(TAG_WPA_WPA, "Enabling 192 bit certification");
